...
export function GoalHeader() {
  const { goal, cwd, profile, remote, planEntries, sessionId, status, approvals, markStopped, beginReconnect } = useCoworkStore();
  ...
  const reconnect = () => {
    ...
    void window.hermes.acp.load({ sessionId, profile, cwd, isolate: true, remote })
